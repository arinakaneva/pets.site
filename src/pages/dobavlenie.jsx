        ...
        <div>
            ...
            <form className="contei w-50 m-auto p-5" id="dobav" noValidate onSubmit={dobav}>
                ...
                <details className="w-100 d-flex flex-column justify-content-center align-items-center">
                    <summary className="btn btn-danger w-50 d-flex flex-column justify-content-center align-items-center" style={{ "margin": "auto", "marginbBottom": "20px" }}>
                        Зарегистрироваться
                    </summary>
                    <div className="d-flex flex-column justify-content-center align-items-center w-50" style={{ "margin": "auto" }}>
                        <div className="mb-4 w-100">
                            <br />
                            <input type="password" className="form-control border border-danger" placeholder="Пароль" required name="password" />
                        </div>
                        <div className="mb-4 w-100">
                            <input type="password" className="form-control border border-danger" placeholder="Введите пароль повторно" required name="password_confirmation" />
                        </div>
                    </div>
                </details>
                <br />
                <div className="d-flex justify-content-center align-items-center">
                    <button type="submit" className="btn btn-danger">Выложить объявление</button>
                </div>
            </form>
